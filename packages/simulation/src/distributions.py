...
def arrival_probability(hour: int) -> float:
    """
    Calculate arrival probability T1 for a given hour of the day.
...
def sample_charging_needs_km() -> int:
    ...
    probabilities = np.array([0.3431, 0.049, 0.098, 0.1176, 0.0882, 0.1176, 0.1078, 0.049, 0.0294])
...
def sample_arrival(hour: int) -> bool:
    """
